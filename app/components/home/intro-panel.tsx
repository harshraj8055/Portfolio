...
export default function IntroPanel() {
  return (
    <div className="relative w-full select-none space-y-6 xl:w-1/2 2xl:w-6/12 2xl:space-y-8">
      ...
      I'm an Aspiring  Product Manager, studying at the{" "} <span className="text-typewriter">  Indian Institute of Information Technology Guwahati</span>{" "}. Building Innovative and a vision-driven product drives me to create experiences for people. 
      </p>
